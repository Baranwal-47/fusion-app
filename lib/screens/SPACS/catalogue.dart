...
class _CataloguePageState extends State<CataloguePage> {
          ...
          children: [
            ...
            SingleChildScrollView(
              ...
              padding: const EdgeInsets.symmetric(
                  horizontal: 8), // Padding at start and end
              child: Row(
                children: [
                  _buildTabButton(
                    index: 0,
  ...
  Widget _buildTabButton(
    ...
    return Padding(
      padding:
          const EdgeInsets.symmetric(horizontal: 4), // Space between buttons
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              '• A holder of any other scholarship from another source is not eligible unless it’s renewed.',
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                    if (selectedProgramme == 'B.Tech' &&
                        selectedYear == '2022-2023' &&
                        selectedScholarship == 'Director’s Gold Medal') {
                      setState(() {
